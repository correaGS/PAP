            ...
            if ($resultadoUsers->num_rows > 0) {
                ...
                if ( $stmt = mysqli_prepare($_conn, $sql) ) {
                    ...
                    $mensagem = "Caro(a) $nome" . "," . "\r\n" .  "\r\n" .
                        ...
                        "<a class='w3-text-purple' href='$urlPagina userAtivarConta.php?id=$id&code=$code'>Ativar Conta</a><br>"."\r\n" ."\r\n" . 
...
<div class="center">
      ...
      <form form action="#" method="POST">
        ...
        <button type="button" class="w3-btn" onClick="location.href='userEntrar.php'">Já tenho conta</button>
      </form>
